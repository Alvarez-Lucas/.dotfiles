...
vim.keymap.set({ "n", "v" }, "<leader>y", '"+y', defaultOpts) -- yank motion
vim.keymap.set({ "n", "v" }, "<leader>Y", '"+Y', defaultOpts) -- yank line
vim.keymap.set({ "n", "v" }, "<leader>d", '"+d', defaultOpts) -- delete motion
vim.keymap.set({ "n", "v" }, "<leader>D", '"+D', defaultOpts) -- delete line
vim.keymap.set("n", "<leader>p", '"+p', defaultOpts) -- paste after cursor
vim.keymap.set("n", "<leader>P", '"+P', defaultOpts) -- paste before cursor
vim.keymap.set("v", "<leader>p", '"+p', defaultOpts)
vim.keymap.set("n", "<Leader>xy", "<cmd>call setreg('+', getreg('@'))<CR>", defaultOpts)

vim.keymap.set("v", "p", '"_dP', defaultOpts) -- Keep register after paste
-- vim.keymap.set("n", "<Leader>xy", "<cmd>call setreg('+', getreg('@'))<CR>", defaultOpts)

-- vim.keymap.set("n", "<c-d>", "<c-d>zz", defaultOpts) -- Keep cursor line centered on page scroll
-- vim.keymap.set("n", "<c-u>", "<c-u>zz", defaultOpts)

vim.keymap.set("n", "n", "nzzzv")
vim.keymap.set("n", "N", "Nzzzv")

vim.keymap.set("v", "Y", "y$", defaultOpts) -- Yank to end of line
...
vim.keymap.set("n", "<c-e>", function()
	vscode.action("vscode-harpoon.editEditor")
end, defaultOpts)
