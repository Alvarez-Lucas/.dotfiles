...
nnoremap <leader>j :vsc Harpoon.OverwriteTab0<cr>
nnoremap <leader>k :vsc Harpoon.OverwriteTab1<cr>
nnoremap <leader>l :vsc Harpoon.OverwriteTab2<cr>
nnoremap <leader>; :vsc Harpoon.OverwriteTab3<cr>
